...
CREATE TABLE UserDetails (id INT AUTO_INCREMENT, username VARCHAR(50), hashedPassword VARCHAR(50),firstname VARCHAR(50), lastname VARCHAR(50), email VARCHAR(50), PRIMARY KEY(id));
